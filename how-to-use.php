...
<html lang="en" dir="ltr">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="how-to-use.php">HOW TO USE</a></li>
				</ul>
	...
	<body>
		<div id="howto" class="container">
			...
			<div class="row">
			    <div id="persliceAnimation" class="howtoAnimation">
			        <div class="row">
...
function button14Click () {
  ...
  $("#sizeNumber").text("14");
			...
			<div class="row">
				...
				<img id="howtoPerslice" class="howtoAnimation" src="img/Perslice.jpg" alt="Cake slicer and server">
				<div class="howtoBox">
